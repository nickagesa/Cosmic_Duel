...
BORDER = pygame.Rect(SCREEN_WIDTH//2 - 5, 0, 2, SCREEN_HEIGHT) # (x,y,width,height)
...
BULLET_FIRE_SOUND.set_volume(0.03) 
BULLET_HIT_SOUND.set_volume(0.03)   
VICTORY_SOUND.set_volume(0.03)  
...
def draw_window(bg_scroll,red, yellow, yellow_bullets, red_bullets, red_health, yellow_health):
    ...
    # DRAW SPACESHIPS
    GAME_WIN.blit(YELLOW_SPACESHIP, (yellow.x, yellow.y))  # yellow spaceship
    GAME_WIN.blit(RED_SPACESHIP, (red.x, red.y))  # red spaceshipip

     # DRAW SEPARATOR BORDER
    pygame.draw.rect(GAME_WIN, BLUE, BORDER) 

    # DRAW MULTIPLE BULLETS #
    for bullet in yellow_bullets:  
        pygame.draw.rect(GAME_WIN, YELLOW, bullet)  
